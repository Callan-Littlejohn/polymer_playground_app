# -*- coding: utf-8 -*-
"""
Created on Thu Aug 21 10:06:37 2025
...
def pipeline2(infile,  expected_endgroups,expected_adducts,repeat_unit,maxcharge,maxtol): # targetted pipeline
    ...
    for i in range(len(peaks)):
        ...
        if 1==1:   
            ...
            form2=findcomp(peaks[i], ["C","H","N","O","Na"], [0,0,0,0,0], [10,24,1,3,3], tol,min(mip[i]),elements_functions.formula_to_mass(repeat_unit))
